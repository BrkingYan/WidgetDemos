...
public class FastJsonTest {
    ...
    public static void main(String[] args){
        ...
        Father father = JsonUtil.jsonToObj(fatherJsonString,Father.class);
        Child child = JsonUtil.jsonToObj(childJsonString,Child.class);
        System.out.println(father);
        System.out.println(child);

        //把json字符串转换为List
        System.out.println("把json字符串转换为List");
        List<Father> fatherList = JsonUtil.jsonToList(fatherListJsonString,Father.class);
        List<Child> childList = JsonUtil.jsonToList(childListJsonString,Child.class);
        System.out.println(fatherList);
        System.out.println(childList);

        //把对象转换为json字符串
        System.out.println("把对象转换为json字符串");
        String fatherString = JsonUtil.objToJson(father);
        String childString = JsonUtil.objToJson(child);
        ...
        String fatherListJson = JsonUtil.listToJson(fatherList);
        ...
        String childListJson = JsonUtil.listToJson(childList);
        ...
        String childMapString = JsonUtil.mapToJson(childMap);
        System.out.println(childMapString);

        String fatherMapString = JsonUtil.mapToJson(fatherMap);
        System.out.println(fatherMapString);


        //将jsonString转换为Map
        System.out.println("将jsonString转换为Map");
        Map<String,Father> fatherMap = JsonUtil.jsonToMap(fatherMapJsonString,Father.class);
        Map<String,Child> childMap = JsonUtil.jsonToMap(childMapJsonString,Child.class);
